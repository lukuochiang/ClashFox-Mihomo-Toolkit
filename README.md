...
# [ClashFox-Mihomo-Toolkit](https://github.com/lukuochiang/ClashFox-Mihomo-Toolkit)
...
### 🌍 语言支持
- **自动语言检测**：智能识别系统语言环境（中文/英文/日文/韩文/法文/德文/俄文）
- **多语言支持**：完全支持中文和英文/日文/韩文/法文/德文/俄文界面
- **手动切换**：可通过环境变量 `CLASHFOX_LANG=zh|en|ja|ko|fr|de|ru|auto` 手动设置语言
- **无缝切换**：界面元素和提示信息自动适配当前语言设置
